...
const Sidebar = () => {
  return (
    <nav className="h-screen hidden sm:flex flex-col sticky top-0 p-3 xl:ml-20">
        ...
        <div className="py-3">
            <Image src={'/assets/butterfly.png'} width={48} height={48} alt="butterfly logo"/>
        </div>
        <ul>
            ...
            <button className="hidden xl:block bg-[#f288ad] w-[200px] h-[52px] rounded-full text-white font-medium cursor-pointer shadow-md mt-2">Bubble</button>
        </ul>
